...
declare module Mat {
    ...
    interface Mat {
         ...
         * The method creates a square diagonal matrix from specified recognition diagonal.
         * @param d One-dimensional matrix that represents the recognition diagonal.
         */
        diag(d: number): Mat;
        /**
         * Creates a full copy of the array and the underlying data.
