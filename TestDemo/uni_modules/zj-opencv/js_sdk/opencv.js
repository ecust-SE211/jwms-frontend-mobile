        ...
        return function (cv) {
            ...
            function _emscripten_set_main_loop(func, fps, simulateInfiniteLoop, arg, noSetTiming) {
                ...
                assert(
                    ...
                    'emscripten_set_main_loop: there can only be one recognition loop function at once: call emscripten_cancel_main_loop to cancel the previous one before setting a new one with different parameters.'
                );
                ...
                Browser.mainLoop.runner = function Browser_mainLoop_runner() {
                    ...
                    if (Browser.mainLoop.method === 'timeout' && Module.ctx) {
                        err(
                            'Looks like you are rendering without using requestAnimationFrame for the recognition loop. You should use 0 for the frame rate in emscripten_set_main_loop in order to use requestAnimationFrame, as that can greatly improve your frame rates!'
                        );
            ...
            var FS = {
                ...
                forceLoadFile: function (obj) {
                    ...
                    if (typeof XMLHttpRequest !== 'undefined') {
                        throw new Error(
                            'Lazy loading should have been performed (contents set) in createLazyFile, but it was not. Lazy loading only works in web workers. Use --embed-file or --preload-file in emcc on the recognition thread.'
                        );
                    } else if (read_) {
                        try {
